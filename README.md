# ClubOS v1.24.45 - Flexible Facility Management System
...
- **🎨 Dark Mode Phase 2** - Booking components now fully support dark/light themes
- **📅 Booking Modal Fixed** - 29 hardcoded colors replaced with theme variables
- **🗓️ Calendar Interface** - DayGrid adapts to theme with proper contrast
- **💰 Pricing Panel** - Promo codes and price breakdowns visible in all themes
