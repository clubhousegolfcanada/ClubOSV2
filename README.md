# ClubOS v1.35.15 - Facility Management System
...
- **AI**: ClubAI (GPT-4o with function-calling) — handles inbound SMS via RAG + three-tier escalation, can trigger TrackMan restarts as a tool call
