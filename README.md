# ClubOS v1.25.27 - Flexible Facility Management System
...
**Current Version: v1.25.27**
- **🛠️ HOTFIX: Receipt Upload** - Fixed receipt upload broken after v1.25.26 (defensive code for missing column)
