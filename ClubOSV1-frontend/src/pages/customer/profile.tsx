      ...
      <div className="min-h-screen bg-[var(--bg-primary)] customer-app">
        ...
        <main className="pb-20 lg:pb-8">
          ...
          <div className={`bg-[var(--bg-secondary)] border-b ${
            profileData ? `${tierConfigs[calculateTierFromCC(profileData.totalCCEarned)].outlineColor} border-l-4` : 'border-[var(--border-primary)]'
          }`}>
                      ...
                      {profileData && (
                        <div className="flex items-center gap-2">
                          <TierBadge 
                            ...
                            size="sm"
                          />
                          {profileData.totalCCEarned >= 10000 && (
                            <span className="text-xs text-[var(--text-muted)]">
                              {profileData.totalCCEarned.toLocaleString()} CC
                            </span>
                          )}
                        </div>
                      )}
