  ...
  try {
    ...
    await db.query(`
      ...
      SELECT * FROM (VALUES
        ...
        ('trackman_reset', 'Trackman Reset', 'Automatically reset frozen or unresponsive Trackman units via the TrackMan agent', 'technical', false,
          '{"requires_confirmation": true, "confirmation_message": "If you signed in to your Trackman account before starting, I can reset the system quickly and you can pick back up through the ''My Activities'' button. Let me know and I''ll reset it.", "trackman_command_type": "restart"}'::jsonb,
          ARRAY['admin', 'operator']),
