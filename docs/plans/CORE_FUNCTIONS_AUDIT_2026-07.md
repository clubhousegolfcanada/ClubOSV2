...
> - ⬜ **Still open:** H7 (the last high) + the medium batch.
> - ⏸️ **Needs a design decision (H7):** should auto-corrections go to a review queue, or write live with a stricter threshold? This one changes ClubAI learning behavior — held for owner input. **All other highs are shipped.**
